...
public class RaceManager : MonoBehaviour
{
    ...
    public void AddRacer(GameObject racer)
    {
        ...
        {
            racer.GetComponent<OpponentCharacterControllerAstar>().raceStartPoint = randomStartPos;
            Transform randomEndPos = raceEndLocations[Random.Range(0, raceEndLocations.Count)];
            racer.GetComponent<OpponentCharacterControllerAstar>().raceEndPoint = randomEndPos;
